...
<head>
    ...
    <title>EventHub Manager - Add Event</title>
...
<body class="bg-background dark:bg-[#0b1c30] text-on-background dark:text-white font-body-md min-h-screen flex antialiased">
    ...
    <nav class="bg-surface dark:bg-inverse-surface fixed left-0 top-0 h-full w-60 border-r border-outline-variant dark:border-[#334155] flex flex-col py-md transition-colors duration-200 ease-in-out z-20 hidden md:flex">
        ...
        <ul class="flex-1 overflow-y-auto px-sm">
            ...
            <li><a class="flex items-center px-md py-sm mb-xs rounded text-secondary dark:text-secondary-fixed font-bold border-r-4 border-secondary bg-surface-container-high dark:bg-[#1E293B] transition-colors duration-200 ease-in-out" href="add_event.jsp"><span class="material-symbols-outlined mr-sm" data-weight="fill">add_circle</span> <span class="font-body-md text-body-md">Add Event</span></a></li>
        ...
        <main class="flex-1 p-lg md:p-xl bg-background dark:bg-[#0b1c30] overflow-y-auto">
            <div class="max-w-container-max mx-auto">
                <% String message = (String) request.getAttribute("message");
                   if (message != null) { %>
                    <div class="mb-md p-md rounded bg-surface-container-high dark:bg-[#1E293B] border border-outline-variant dark:border-[#334155] text-primary dark:text-primary-fixed font-body-sm"><%= message %></div>
                <% } %>

                <form action="AddEventServlet" method="POST">
                    <div class="flex justify-between items-end mb-xl">
                        <div>
                            <h2 class="font-display-lg text-display-lg text-on-surface dark:text-white">Create New Event</h2>
                            <p class="font-body-md text-body-md text-on-surface-variant dark:text-gray-400 mt-xs">Fill in the details below to publish a new event.</p>
                        </div>
                        <div class="flex gap-sm">
                            ...
                            <button type="submit" class="bg-[#00ADEF] text-on-primary dark:text-white font-body-sm text-body-sm font-semibold py-sm px-md rounded hover:bg-secondary dark:hover:bg-[#0095CC] transition-colors">Publish Event</button>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-xl">
                            ...
                            <div class="space-y-md">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input name="eventName" type="text" placeholder="e.g. Tech Conference" class="w-full bg-surface dark:bg-[#0b1c30] border border-outline-variant dark:border-[#334155] rounded px-sm py-sm font-body-md text-body-md text-on-surface dark:text-white focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary transition-all" required/>
                                </div>
                                <div class="flex flex-col">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input name="location" type="text" class="w-full bg-surface dark:bg-[#0b1c30] border border-outline-variant dark:border-[#334155] rounded px-sm py-sm font-body-md text-body-md text-on-surface dark:text-white focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary transition-all" required/>
                                    </div>
                                </div>
                            </div>
                            <!-- Schedule & Logistics -->
                            <div class="space-y-md">
                                ...
                                <div class="grid grid-cols-2 gap-md">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input name="price" type="number" step="0.01" class="w-full bg-surface dark:bg-[#0b1c30] border border-outline-variant dark:border-[#334155] rounded px-sm py-sm font-body-md text-body-md text-on-surface dark:text-white focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary transition-all"/>
                                    </div>
                                </div>
                            </div>
                        </div>
